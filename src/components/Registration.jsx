...
const Registration = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const localStartDate = new Date(
      startDate.getTime() - berlinTimezoneOffset * 60 * 1000
    )
    const localEndDate = new Date(
      endDate.getTime() - berlinTimezoneOffset * 60 * 1000
    )
    ...
    try {
      const deploymentId =
        "AKfycbzwko6rg5GRCTlQyFSomcQ_KpIeaoXX3Obx546pzl-Dcx-a5untal0-aTsCQuwczpRJ"
  ...
  const isDisabled =
    !name || !email || !phone || !startDate || !endDate || isSubmitting
